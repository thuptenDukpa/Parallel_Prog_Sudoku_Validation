...
// Output file
ofstream output_file("MCS-LogFile.txt");
...
int main() {
    ...
    cout << "MCS Lock Output: " << endl;
    output_file << "MCS Lock Output:" << endl;
    // Start time
